...
import net.torrydev.microservices.commentsservice.service.RabbitMqPubServiceImpl;
...
import static net.torrydev.microservices.commentsservice.constants.ServiceConstants.COMMENT_REST_POINTS;
...
public class RabbitMQController {
    ...
    public static final String RABBIT_CONTROLLER_API = COMMENT_REST_POINTS + "/rmq";
    @Autowired
